            ...
            <div class="flex">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="name" type="text" class="form-input w-full border-2 @error('name')  border-red-500 @enderror"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="email" type="email"
                            class="form-input w-full  border-2 @error('email') border-red-500  @enderror" name="email"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="password-confirm" type="password" class="form-input w-full border-2"
